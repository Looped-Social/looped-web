    ...
    <div className="space-y-6">
          ...
          {!selectedReport ? (
            ...
            <div className="mt-4 space-y-4 text-sm text-text-secondary">
              ...
              {hasActions ? (
                ...
                <p className="text-xs text-text-secondary">No actions available for this report.</p>
              )}
      ...
      {isActionsOpen && selectedReport && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6">
          ...
          />
          <div
            className="relative w-full max-w-2xl rounded-2xl border border-border bg-bg p-6 shadow-[0_24px_60px_rgba(15,23,42,0.35)]"
            role="dialog"
            aria-modal="true"
          >
            <div className="flex items-center justify-between gap-4">
              <div>
                <h2 className="text-lg font-semibold text-strong">Report actions</h2>
                <p className="mt-1 text-xs text-text-light">
                  Report #{selectedReport.id} · {selectedReport.target_type} #{selectedReport.target_id}
                </p>
              </div>
              <button
                type="button"
